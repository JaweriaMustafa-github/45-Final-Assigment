...
// 2.Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in 
// the current_users list.

// 3.Loop through the new_users list to see if each new username has already been used. If it has, print a message
...
let new_users : string[] = ["admin", "user4", "user5", "user6", "user7"];
